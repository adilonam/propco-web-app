        ...
        await fetch(url, {
          ...
          body: JSON.stringify({
            ...
            reply_markup: {
              ...
              [
                { text: 'Buy Propco on Bitmart', url: 'https://www.bitmart.com/trade/en-US?symbol=PROPCO_USDT' }
              ]
              ,
              [
                { text: 'Buy Propco on Uniswap', url: 'https://app.uniswap.org/explore/pools/polygon/0xd3ed7dF705e8399BE84838861173dDFC8124c251' }
              ]
              ]
            },
          }),
